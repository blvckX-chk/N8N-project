...
| 4 | **Agent Frontend** | **V6.22** | `frontend` | … (filtres + actions groupées) + **PWA installable** (manifest + service worker « coquille seule », icône SVG) — app installable, aucune donnée métier cachée |
...
| Frontend V6.22 | `_app_js`, `_login_html`, `html/css` | ZIP, Build Final Response | ✅ fichiers front autonomes, aucun agent aval ne les re-parse |
