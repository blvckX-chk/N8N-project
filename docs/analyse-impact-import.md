...
| 4 | **Agent Frontend** | **V6.21** | `frontend` | … (comme V6.20 : UI de filtres) + **actions groupées** (cases à cocher, tout sélectionner, suppression/export en lot ; suppression = endpoint scopé user_id, export CSV client-side sûr) |
...
| Frontend V6.21 | `_app_js`, `_login_html`, `html/css` | ZIP, Build Final Response | ✅ fichiers front autonomes, aucun agent aval ne les re-parse |
